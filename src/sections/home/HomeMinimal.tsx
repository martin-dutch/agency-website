...
const CARDS = [
  {
    ...
    title: 'UI & UX Design',
    description:
      'We help you design a more delightful experience for your customers.',
  },
  {
    icon: 'https://minimal-assets-api-dev.vercel.app/assets/icons/ic_code.svg',
    title: 'Development',
    description: 'We use out of the box solutions to build your product faster.',
  },
  {
    icon: '/logo/logo_single.svg',
    title: 'Branding',
    description: 'We help you build a brand that stands out.',
  },
];
      ...
      <Container component={MotionViewport}>
        ...
        >
          ...
          <m.div variants={varFade().inDown}>
            <Typography variant="h2">What Linkway helps you with?</Typography>
          </m.div>
        </Box>
